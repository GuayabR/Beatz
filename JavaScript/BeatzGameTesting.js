...
function getDynamicSpeed(songSrc) {
    const dynamicSpeeds = {
        ...
        "Lunar Abyss": [
            { timestamp: 7, noteSpeed: 12 },
            { timestamp: 14, noteSpeed: 16 },
            { timestamp: 27.9, noteSpeed: 14 },
            { timestamp: 41.8, noteSpeed: 12 },
            { timestamp: 53.92, noteSpeed: 10 },
            { timestamp: 55.72, noteSpeed: 18 },
            { timestamp: 81.78, noteSpeed: 13 },
            { timestamp: 83.55, noteSpeed: 14 },
            { timestamp: 97.42, noteSpeed: 11 },
            { timestamp: 111.45, noteSpeed: 12 },
            { timestamp: 124.4, noteSpeed: 15 },
            { timestamp: 124.5, noteSpeed: 12 },
            { timestamp: 124.75, noteSpeed: 15 },
            { timestamp: 124.79, noteSpeed: 12 },
            { timestamp: 124.81, noteSpeed: 15 },
            { timestamp: 124.84, noteSpeed: 11 },
            { timestamp: 125.33, noteSpeed: 14 },
            { timestamp: 137.38, noteSpeed: 11 },
            { timestamp: 139.19, noteSpeed: 18 },
            { timestamp: 142.64, noteSpeed: 11 },
            { timestamp: 143.54, noteSpeed: 14 },
            { timestamp: 146.14, noteSpeed: 18 },
            { timestamp: 155.84, noteSpeed: 10 },
            { timestamp: 156.17, noteSpeed: 12 },
            { timestamp: 160.027, noteSpeed: 18 },
            { timestamp: 168.7, noteSpeed: 10 },
            { timestamp: 169.57, noteSpeed: 5 },
            { timestamp: 170.14, noteSpeed: 12 },
            { timestamp: 173.95, noteSpeed: 15 },
            { timestamp: 179.15, noteSpeed: 12 },
            { timestamp: 179.2, noteSpeed: 8 },
            { timestamp: 179.25, noteSpeed: 14 },
            { timestamp: 179.3, noteSpeed: 10 },
            { timestamp: 179.35, noteSpeed: 2 },
            { timestamp: 179.4, noteSpeed: 6 },
            { timestamp: 179.45, noteSpeed: 12 },
            { timestamp: 179.5, noteSpeed: 8 },
            { timestamp: 179.55, noteSpeed: 10 },
            { timestamp: 179.6, noteSpeed: 12 },
            { timestamp: 179.65, noteSpeed: 10 },
            { timestamp: 179.7, noteSpeed: 6 },
            { timestamp: 180.12, noteSpeed: 10 },
            { timestamp: 180.62, noteSpeed: 12 },
            { timestamp: 180.93, noteSpeed: 16 },
            { timestamp: 186.09, noteSpeed: 2 },
            { timestamp: 186.1, noteSpeed: 10 },
            { timestamp: 186.15, noteSpeed: 2 },
            { timestamp: 186.2, noteSpeed: 10 },
            { timestamp: 186.25, noteSpeed: 2 },
            { timestamp: 186.3, noteSpeed: 10 },
            { timestamp: 186.35, noteSpeed: 2 },
...
function closeSongList() {
    ...
    songListModal.style.display = "none";
    keywordListModal.style.display = "none";
    activateKeybinds();
}
...
var keywordDescriptions = {
    ...
    goat: "Only results from The Greatest Of All Time, including Kanye, Kendrick, Eminem, Creo, Travis, Linkin Park, MRL",
    "got bit by a goat": "Only results from Eminem",
    marshall: "Only results from Eminem",
    "marshall mathers": "Only results from Eminem",
...
document.getElementById("keywordListButton").onclick = function () {
    const keywordListModal = document.getElementById("keywordListModal");
    const keywordDescriptionsDiv = document.getElementById("keywordDescriptions");

    // Clear any existing content
    keywordDescriptionsDiv.innerHTML = "";
...
// Function to close the keyword list modal
document.getElementById("closeKeywordListModal").onclick = function () {
    document.getElementById("keywordListModal").style.display = "none";
};
...
function skipToLastSong() {
    ...
    // Check if the last song is "Resources/Songs/testingsong.mp3"
    if (songList[songList.length - 1] === "Resources/Songs/testingsong.mp3") {
        currentSongIndex = songList.length - 2; // Skip to the second to last song
    } else {
        currentSongIndex = songList.length - 1; // Otherwise, go to the last song
    }
...
function skipToFirstSong() {
    ...
    currentSongIndex = 0; // Set to the first index
            ...
            speedUpdater = setInterval(() => {
                if (currentSong && songConfig && currentConfigIndex < songConfig.length) {
                    ...
                    if (currentTime >= nextConfig.timestamp) {
                        ...
                        console.log(`Updated note speed to: ${noteSpeed} at timestamp: ${nextConfig.timestamp} (${formatTimestampDS(nextConfig.timestamp)})`);
                        if (nextConfig.BPM) {
                            BPM = nextConfig.BPM;
    ...
    if (currentSong.src.startsWith("https://guayabr.github.io")) {
        ...
        try {
            ...
            currentSong.addEventListener("loadeddata", () => {
                ...
                document.title = `Song ${indexToDisplay + 1}: ${getSongTitle(currentSongPath)} | Beatz Testing 5.3!`;
...
function takeScreenshotWithBackground(backgroundImagePath = "https://guayabr.github.io/Beatz/Resources/defaultBG.png") {
